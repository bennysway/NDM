...
public class Credits extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView cr1 = (TextView) findViewById(R.id.credit1);
        TextView cr2 = (TextView) findViewById(R.id.credit2);
        TextView cr3 = (TextView) findViewById(R.id.credit3);
        TextView cr4 = (TextView) findViewById(R.id.credit4);
        TextView cr5 = (TextView) findViewById(R.id.credit5);
        ImageView cr6 = (ImageView) findViewById(R.id.credit6);
        ImageView cr7 = (ImageView) findViewById(R.id.credit7);
        ImageView cr8 = (ImageView) findViewById(R.id.credit8);
        ImageView cr9 = (ImageView) findViewById(R.id.credit9);
        ImageView cr10 = (ImageView) findViewById(R.id.credit10);
        ImageView cr11 = (ImageView) findViewById(R.id.credit11);
        ImageView cr12 = (ImageView) findViewById(R.id.credit12);
        ImageView cr13 = (ImageView) findViewById(R.id.credit13);
        ImageView cr14 = (ImageView) findViewById(R.id.credit14);
        TextView cr15 = (TextView) findViewById(R.id.credit15);
        TextView cr16= (TextView) findViewById(R.id.credit16);
        TextView cr17 = (TextView) findViewById(R.id.credit17);
        ImageView cr18 = (ImageView) findViewById(R.id.credit18);
